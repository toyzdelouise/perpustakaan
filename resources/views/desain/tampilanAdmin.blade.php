        ...
        <div class="row flex-nowrap">
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <a class="nav-link dropdown-toggle" href="#!" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Hello, Admin {{Auth::user()->name}}</a>
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        <li class="nav-item">
                            <a href="{{ route('admin.tampilan') }}" class="nav-link align-middle px-0">
                                <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline" style="color: white">Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('tampilan.create')}}" class="nav-link px-0 align-middle">
                        ...
                        {{-- <li>
                            <a href="{{ route('admin.book-rent') }}" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-people"></i> <span class="ms-1 d-none d-sm-inline" style="color: white">Book Rent</span>
                            </a>
                        </li> --}}
                        {{-- <li>
                            <a href="{{ url('authe/logout') }}{{Auth::guard('admin')->user()->name}}" class="nav-link px-0 align-middle">
