            ...
            <tbody>
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('tampilan.show', $item->id)); ?>" class="btn btn-secondary btn-sm">Detail</a>
                           <a href="<?php echo e(route('tampilan.edit', $item->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                           <form onsubmit="return confirm('Yakin Data Akan Dihapus')" class="d-inline"
                               action="<?php echo e(route('tampilan.delete', $item->id)); ?>" method="post">
                               <?php echo csrf_field(); ?>
...
<?php echo $__env->make('desain.sidebaradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projeklaravel\apperpustakaan\resources\views/admin/tampilan.blade.php ENDPATH**/ ?>