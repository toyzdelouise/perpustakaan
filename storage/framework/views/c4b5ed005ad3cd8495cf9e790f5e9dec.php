    ...
    <form action='<?php echo e(url('kelas')); ?>' method='post'>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='nama_kelas' value="<?php echo e(Session::get('nama_kelas')); ?>"
                        id="nama_kelas">
                </div>
            </div>
            <div class="mb-3 row">
...
<?php echo $__env->make('kelas.desain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projeklaravel\apperpustakaan\resources\views/kelas/kelas.blade.php ENDPATH**/ ?>