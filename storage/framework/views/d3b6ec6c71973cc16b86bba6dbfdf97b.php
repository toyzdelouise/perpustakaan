<?php $__env->startSection('konten'); ?>
    <form action='<?php echo e(url('buku/'.$data->id)); ?>' method='post' enctype="multipart/form-data">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <a href="<?php echo e(route('account.dashboard')); ?>" class="btn btn-secondary"><< Kembali</a>
            <div class="row mt-3">
                <?php if($data->foto): ?>
...
<?php echo $__env->make('desain.tampilan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projeklaravel\apperpustakaan\resources\views/buku/bukudetail.blade.php ENDPATH**/ ?>