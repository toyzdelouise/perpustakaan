<?php $__env->startSection('konten'); ?>
    ...
    <form action='<?php echo e(route('book.update', $data->id)); ?>' method='post' enctype="multipart/form-data">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <a href="<?php echo e(route('admin.tampilan')); ?>" class="btn btn-secondary">
                << Kembali</a>
                    <div class="mb-3 row">
...
<?php echo $__env->make('desain.sidebarAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projeklaravel\apperpustakaan\resources\views/admin/bukuedit.blade.php ENDPATH**/ ?>