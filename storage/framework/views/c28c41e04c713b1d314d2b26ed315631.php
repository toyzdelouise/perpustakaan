...
<body>
    ...
    <section id="about" class="about">
        ...
        <div class="row">
            <div class="about-img">
                <img src="<?php echo e(asset('asset/4.png')); ?>" alt="Tentang Kami">
            </div>
            <div class="content">
    ...
    <section id="fitur" class="fitur">
        ...
        <div class="row">
            <div class="about-img">
                <img src="<?php echo e(asset('asset/5.jpg')); ?>" alt="Tentang Kami">
            </div>
            <div class="content">
    ...
    <section id="contact" class="contact">
        ...
        <div class="row">
            <div class="about-img">
                <img src="<?php echo e(asset('asset/6.png')); ?>" alt="Tentang Kami">
            </div>
            <div class="content">
...
<?php /**PATH C:\Users\Abdullah Singkar\Documents\apperpustakaan\resources\views/desain/landingpage.blade.php ENDPATH**/ ?>